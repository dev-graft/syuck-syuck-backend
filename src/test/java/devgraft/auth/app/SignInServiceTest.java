...
class SignInServiceTest {
    ...
    void signIn_passes_SignInData_To_AuthSessionProvider() {
        final EncryptedSignInRequest givenRequest = EncryptedSignInRequestFixture.anRequest().build();
        final KeyPair givenKeyPair = KeyPairFixture.anKeyPair();
        final DecryptedSignInData givenSignData = DecryptedSignInDataFixture.anData().loginId("devgraft").build();
    ...
    void signIn_returnValue() {
        ...
        final SignInResult signInResult = signInService.signIn(givenRequest, givenKeyPair);
