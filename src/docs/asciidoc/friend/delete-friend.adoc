...
== 친구 삭제
operation::delete-friend-api-doc/delete-friend[snippets='curl-request,request-headers,request-parameters']
operation::delete-friend-api-doc/delete-friend[snippets='http-response,response-fields']